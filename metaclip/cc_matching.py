...
class WARCCurator(CCCurator):
    ...
    def parse(self, cc_file, verbose=True):
        ...
        with open(cc_file, 'rb') as stream:
            ...
            for ix, record in tqdm(enumerate(record_iter)):
...
def remove_sep(data):
    cleaned_text = re.sub(r'<__dj__image> | <\|__dj__eoc\|>', '', data['text']).strip()
    return {
        'images': data['images'],
        'texts': [['alt', cleaned_text]]
    }


# if __name__ == '__main__':
#     cc_file = "data/CC/warc/CC-MAIN-20180420081400-20180420101400-00000.warc.gz"
#     output_file = "data/CC/matched/CC-MAIN-20210723143921-20210723173921-00000.warc.gz.json"
